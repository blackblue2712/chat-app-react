    ...
    render() {
        ...
        return (
            <div className={`message ${isMe}`}>
                {!isMe && <img className="avatar-md" src="./imgs/753453.png" data-toggle="tooltip" data-placement="top" alt="avatar" />}
                    ...
                    <div className={`text-group ${isMe}`}>
                        <div className={`text ${isMe}`}>
                            <div className="attachment">
                                ...
                                <div className="file">
                                    <h5><a href="/file" title="Click to download">{filename}</a></h5>
                                    <span>{capacity}</span>
                                </div>
                            </div>
                        </div>
